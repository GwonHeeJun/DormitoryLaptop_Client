...
const dummyData = [
  [{ seated : 0 }, { seated : 1 }, { seated : 0 }, { seated : 2 }, { seated : 2 }, { seated : 1 }],
  [{ seated : 0 }, { seated : 0 }, { seated : 1 }, { seated : 2 }, { seated : 1 }, { seated : 0 }],
  [{ seated : 0 }, { seated : 1 }, { seated : 0 }, { seated : 2 }, { seated : 2 }, { seated : 1 }],
  [{ seated : 0 }, { seated : 0 }, { seated : 1 }, { seated : 2 }, { seated : 1 }, { seated : 0 }]
];
              ...
              return (
                <div style={{ display: "flex", height: "60px", marginBottom: "20px" }}>
                  {list.map((item, idx) => {
                    ...
                    if (idx <= 1) {
                      return (
                        <div className={"c-lap__content--right__table-left" + `${item.seated === 0 ? "-not": "" }`}>
